...
namespace Incentive.Infrastructure.Migrations
{
    ...
    [Migration("20250514211743_AddIncentivePlanEntities")]
    partial class AddIncentivePlanEntities
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("IncentivePlans", "IncentiveManagement", t =>
                        {
                            ...
                            t.Property("IsCumulative")
                                .HasColumnName("TargetBasedIncentivePlan_IsCumulative");

                            t.Property("MetricType")
                                .HasColumnName("TargetBasedIncentivePlan_MetricType");

                            t.Property("SalaryPercentage")
                                .HasColumnName("TargetBasedIncentivePlan_SalaryPercentage");
