...
namespace Incentive.Infrastructure.Migrations
{
    ...
    [Migration("20250518082021_UpdateDealsForCurrency")]
    partial class UpdateDealsForCurrency
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Incentive.Core.Entities.Deal", b =>
                {
                    ...
                    b.Property<Guid>("IncentivePlanId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("IncentivePlans", "IncentiveManagement", t =>
                        {
                            ...
                            t.Property("IsCumulative")
                                .HasColumnName("RoleBasedIncentivePlan_IsCumulative");
            ...
            modelBuilder.Entity("Incentive.Core.Entities.Deal", b =>
                {
                    b.HasOne("Incentive.Core.Entities.IncentivePlan.IncentivePlanBase", "IncentivePlan")
                        .WithMany()
                        .HasForeignKey("IncentivePlanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("IncentivePlan");
                });
