...
namespace Incentive.Infrastructure.Services
{
    public class IdentityService : IIdentityService
    {
        ...
        public async Task<(bool Succeeded, string UserId, string Message)> CreateUserAsync(ApplicationUser user, string password)
        {
        ...
        public async Task<bool> AddUserToRoleAsync(string userId, string role)
        {
            ...
            {
                await _roleManager.CreateAsync(new ApplicationRole { Name = role, TenantId = user.TenantId });
            }
